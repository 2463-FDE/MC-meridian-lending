...
`docs/client-asks-originals` branch under this same filename, in commit `4e593e4`
...
`config.POLICY_CORPUS_DIR` (`services/origination-service/app/config.py`) points retrieval at
