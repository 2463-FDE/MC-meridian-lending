...
| **Status** | Open; documented 2026-08-23; not fixed. D3's implementation PR is expected to add `test_the_other_mutations_are_still_a_separate_unlocked_read_then_write` so this stays a recorded decision rather than drifting into an oversight; that test does not exist yet. |
